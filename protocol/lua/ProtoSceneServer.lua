...
Proto4z.register(39010,"SceneServerJoinGroupIns") 
Proto4z.SceneServerJoinGroupIns = {} --创建/加入编队, 来自docker的指令 
Proto4z.SceneServerJoinGroupIns.__protoID = 39010 
...
Proto4z.register(39011,"SceneServerJoinGroupAck") 
Proto4z.SceneServerJoinGroupAck = {} --创建/加入编队响应结果 
Proto4z.SceneServerJoinGroupAck.__protoID = 39011 
...
Proto4z.register(39012,"SceneServerEnterSceneIns") 
Proto4z.SceneServerEnterSceneIns = {} --开辟场景 
Proto4z.SceneServerEnterSceneIns.__protoID = 39012 
...
Proto4z.register(39013,"SceneServerGroupStatusChangeIns") 
Proto4z.SceneServerGroupStatusChangeIns = {} --scene ==> world 
Proto4z.SceneServerGroupStatusChangeIns.__protoID = 39013 
