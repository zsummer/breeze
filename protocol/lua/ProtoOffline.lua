...
Proto4z.register(5200,"UserOffline") 
Proto4z.UserOffline = {}  
Proto4z.UserOffline.__protoID = 5200 
Proto4z.UserOffline.__protoName = "UserOffline" 
Proto4z.UserOffline[1] = {name="id", type="ui32" }  
...
Proto4z.UserOffline[5] = {name="timestamp", type="ui32" }  
