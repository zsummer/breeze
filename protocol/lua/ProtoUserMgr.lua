...
Proto4z.CreateUserFromUserMgrReq[2] = {name="userName", type="string" }  
...
Proto4z.CreateUserFromUserMgrResp[4] = {name="userID", type="ui64" }  
...
Proto4z.AttachUserFromUserMgrReq[1] = {name="userID", type="ui64" }  
...
Proto4z.AttachUserFromUserMgrResp[4] = {name="userID", type="ui64" }  
