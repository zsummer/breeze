...
Protoz.register(101,"CreateUserReq") 
Protoz.CreateUserReq = {} --填写用户信息 
Protoz.CreateUserReq.__getID = 101 
...
Protoz.register(102,"LoginAck") 
Protoz.LoginAck = {} --登录结果 
Protoz.LoginAck.__getID = 102 
...
Protoz.register(103,"ServerPulse") 
Protoz.ServerPulse = {} --服务器生命脉冲 
Protoz.ServerPulse.__getID = 103 
...
Protoz.register(104,"ServerPulseEcho") 
Protoz.ServerPulseEcho = {} --服务器生命脉冲客户端回放 
Protoz.ServerPulseEcho.__getID = 104 
