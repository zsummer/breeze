...
Proto4z.register(41002,"SQLResult") 
Proto4z.SQLResult = {}  
Proto4z.SQLResult.__getID = 41002 
...
Proto4z.register(41000,"SQLQueryReq") 
Proto4z.SQLQueryReq = {}  
Proto4z.SQLQueryReq.__getID = 41000 
Proto4z.SQLQueryReq.__getName = "SQLQueryReq" 
Proto4z.SQLQueryReq[1] = {name="sql", type="string" }  
 
Proto4z.register(41001,"SQLQueryResp") 
Proto4z.SQLQueryResp = {}  
Proto4z.SQLQueryResp.__getID = 41001 
