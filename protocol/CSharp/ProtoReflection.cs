...
namespace Proto4z
{
    static class Reflection
    {
        ...
        static Reflection()
        {
            ...
            _nameToID.Add("EPosition", 10002);
            _idToName.Add(10002, "EPosition");
            ...
            _nameToID.Add("EntityFullData", 10013);
            ...
            _nameToID.Add("SceneServerCancelSceneIns", 39005);
            _idToName.Add(39005, "SceneServerCancelSceneIns");
            ...
            _nameToID.Add("SceneGroupGetReq", 40010);
            _idToName.Add(40010, "SceneGroupGetReq");
            _nameToID.Add("SceneGroupGetResp", 40011);
            _idToName.Add(40011, "SceneGroupGetResp");
            _nameToID.Add("SceneGroupEnterReq", 40012);
            _idToName.Add(40012, "SceneGroupEnterReq");
            _nameToID.Add("SceneGroupEnterResp", 40013);
            _idToName.Add(40013, "SceneGroupEnterResp");
            _nameToID.Add("SceneGroupCancelReq", 40014);
            _idToName.Add(40014, "SceneGroupCancelReq");
            _nameToID.Add("SceneGroupCancelResp", 40015);
            _idToName.Add(40015, "SceneGroupCancelResp");
            ...
            _nameToID.Add("ClientCustomReq", 50016);
            _idToName.Add(50016, "ClientCustomReq");
            _nameToID.Add("ClientCustomResp", 50017);
            _idToName.Add(50017, "ClientCustomResp");
            _nameToID.Add("ClientCustomNotice", 50018);
            _idToName.Add(50018, "ClientCustomNotice");
            _nameToID.Add("ClientPingTestReq", 50019);
