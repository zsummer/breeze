...
namespace Proto4z
{
    static class Reflection
    {
        ...
        static Reflection()
        {
            ...
            _nameToID.Add("EntityControl", 2007);
            _idToName.Add(2007, "EntityControl");
            _nameToID.Add("EntityClientSync", 2008);
            _idToName.Add(2008, "EntityClientSync");
            _nameToID.Add("SceneSection", 2009);
            _idToName.Add(2009, "SceneSection");
            _nameToID.Add("EntitySkillInfo", 2010);
            _idToName.Add(2010, "EntitySkillInfo");
            _nameToID.Add("EntityBuffInfo", 2011);
            _idToName.Add(2011, "EntityBuffInfo");
            _nameToID.Add("EntitySkillSystem", 2012);
            _idToName.Add(2012, "EntitySkillSystem");
            ...
            _nameToID.Add("ReloadDBDictNotice", 3015);
            _idToName.Add(3015, "ReloadDBDictNotice");
            _nameToID.Add("ReloadDBDictFinish", 3016);
            _idToName.Add(3016, "ReloadDBDictFinish");
            _nameToID.Add("KickClientsNotice", 3017);
            _idToName.Add(3017, "KickClientsNotice");
            _nameToID.Add("DBDataResult", 3018);
            _idToName.Add(3018, "DBDataResult");
            _nameToID.Add("DBQueryReq", 3019);
            _idToName.Add(3019, "DBQueryReq");
            _nameToID.Add("DBQueryResp", 3020);
            _idToName.Add(3020, "DBQueryResp");
            _nameToID.Add("DBQueryArrayReq", 3021);
            _idToName.Add(3021, "DBQueryArrayReq");
            _nameToID.Add("DBQueryArrayResp", 3022);
            _idToName.Add(3022, "DBQueryArrayResp");
            _nameToID.Add("WebAgentClientRequestAPI", 3023);
            _idToName.Add(3023, "WebAgentClientRequestAPI");
            _nameToID.Add("WebServerRequest", 3024);
            _idToName.Add(3024, "WebServerRequest");
            _nameToID.Add("WebServerResponse", 3025);
            _idToName.Add(3025, "WebServerResponse");
            _nameToID.Add("AvatarOffline", 3026);
            _idToName.Add(3026, "AvatarOffline");
            ...
            _nameToID.Add("SceneServerGroupStateFeedback", 4006);
            ...
            _nameToID.Add("AOESearch", 11001);
            _idToName.Add(11001, "AOESearch");
            _nameToID.Add("DictBuff", 11002);
