...
namespace Proto4z
{
    static class Reflection
    {
        ...
        static Reflection()
        {
            ...
            _nameToID.Add("EntityModel", 2000);
            _idToName.Add(2000, "EntityModel");
            _nameToID.Add("SceneGroupAvatarInfo", 2001);
            _idToName.Add(2001, "SceneGroupAvatarInfo");
            _nameToID.Add("SceneGroupInfo", 2002);
            _idToName.Add(2002, "SceneGroupInfo");
            _nameToID.Add("EPosition", 2003);
            _idToName.Add(2003, "EPosition");
            _nameToID.Add("SearchInfo", 2004);
            _idToName.Add(2004, "SearchInfo");
            _nameToID.Add("SkillBehaviour", 2005);
            _idToName.Add(2005, "SkillBehaviour");
            _nameToID.Add("SkillData", 2006);
            _idToName.Add(2006, "SkillData");
            _nameToID.Add("BuffData", 2007);
            _idToName.Add(2007, "BuffData");
            _nameToID.Add("SceneEventInfo", 2008);
            _idToName.Add(2008, "SceneEventInfo");
            _nameToID.Add("SkillInfo", 2009);
            _idToName.Add(2009, "SkillInfo");
            _nameToID.Add("BuffInfo", 2010);
            _idToName.Add(2010, "BuffInfo");
            _nameToID.Add("EntityState", 2011);
            _idToName.Add(2011, "EntityState");
            _nameToID.Add("EntityMove", 2012);
            _idToName.Add(2012, "EntityMove");
            _nameToID.Add("EntityReport", 2013);
            _idToName.Add(2013, "EntityReport");
            _nameToID.Add("EntityFullData", 2014);
            _idToName.Add(2014, "EntityFullData");
            _nameToID.Add("SceneSection", 2015);
            _idToName.Add(2015, "SceneSection");
            ...
            _nameToID.Add("DictGlobal", 10000);
            _idToName.Add(10000, "DictGlobal");
            _nameToID.Add("DictRaffleAward", 10001);
            _idToName.Add(10001, "DictRaffleAward");
            _nameToID.Add("DictRafflePool", 10002);
            _idToName.Add(10002, "DictRafflePool");
            _nameToID.Add("DictItem", 10003);
            _idToName.Add(10003, "DictItem");
            _nameToID.Add("DictProp", 10004);
            _idToName.Add(10004, "DictProp");
            _nameToID.Add("DictSceneUpLevel", 10005);
            _idToName.Add(10005, "DictSceneUpLevel");
            _nameToID.Add("DictModel", 10006);
            _idToName.Add(10006, "DictModel");
            _nameToID.Add("DictReward", 10007);
            _idToName.Add(10007, "DictReward");
            _nameToID.Add("DictDrop", 10008);
            _idToName.Add(10008, "DictDrop");
            _nameToID.Add("DictPairValue", 10009);
            _idToName.Add(10009, "DictPairValue");
            _nameToID.Add("DictModelLevel", 10010);
            _idToName.Add(10010, "DictModelLevel");
            _nameToID.Add("AOESearch", 10011);
            _idToName.Add(10011, "AOESearch");
            _nameToID.Add("DictBuffEffect", 10012);
            _idToName.Add(10012, "DictBuffEffect");
            _nameToID.Add("DictBuff", 10013);
            _idToName.Add(10013, "DictBuff");
            _nameToID.Add("DictSkillEffect", 10014);
            _idToName.Add(10014, "DictSkillEffect");
            _nameToID.Add("DictSkill", 10015);
            _idToName.Add(10015, "DictSkill");
            ...
            _nameToID.Add("DictSkillEffect", 11006);
            _idToName.Add(11006, "DictSkillEffect");
