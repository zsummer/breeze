...
namespace Proto4z
{
    static class Reflection
    {
        ...
        static Reflection()
        {
            ...
            _idToName.Add(40019, "ChangeIconIDResp");
            _nameToID.Add("ChangeModeIDReq", 40020);
            _idToName.Add(40020, "ChangeModeIDReq");
            _nameToID.Add("ChangeModeIDResp", 40021);
            _idToName.Add(40021, "ChangeModeIDResp");
