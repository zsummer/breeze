...
namespace Proto4z
{
    static class Reflection
    {
        ...
        static Reflection()
        {
            ...
            _nameToID.Add("ApplyForSceneServerReq", 39003);
            _idToName.Add(39003, "ApplyForSceneServerReq");
            ...
            _nameToID.Add("ChangeIconIDReq", 40030);
            _idToName.Add(40030, "ChangeIconIDReq");
            _nameToID.Add("ChangeIconIDResp", 40031);
            _idToName.Add(40031, "ChangeIconIDResp");
            _nameToID.Add("ChangeModeIDReq", 40032);
            _idToName.Add(40032, "ChangeModeIDReq");
            _nameToID.Add("ChangeModeIDResp", 40033);
            _idToName.Add(40033, "ChangeModeIDResp");
            _nameToID.Add("ChatReq", 40026);
            _idToName.Add(40026, "ChatReq");
            _nameToID.Add("ChatResp", 40027);
            _idToName.Add(40027, "ChatResp");
            ...
            _nameToID.Add("FeedbackAvatarStatusNotice", 39004);
            _idToName.Add(39004, "FeedbackAvatarStatusNotice");
            ...
            _nameToID.Add("PingPongReq", 40028);
            _idToName.Add(40028, "PingPongReq");
            _nameToID.Add("PingPongResp", 40029);
            _idToName.Add(40029, "PingPongResp");
            ...
            _nameToID.Add("SceneGroupCancelEnterReq", 40024);
            _idToName.Add(40024, "SceneGroupCancelEnterReq");
            _nameToID.Add("SceneGroupCancelEnterResp", 40025);
            _idToName.Add(40025, "SceneGroupCancelEnterResp");
            _nameToID.Add("SceneGroupCreateReq", 40012);
            _idToName.Add(40012, "SceneGroupCreateReq");
            _nameToID.Add("SceneGroupCreateResp", 40013);
            _idToName.Add(40013, "SceneGroupCreateResp");
            _nameToID.Add("SceneGroupEnterSceneReq", 40022);
            _idToName.Add(40022, "SceneGroupEnterSceneReq");
            _nameToID.Add("SceneGroupEnterSceneResp", 40023);
            _idToName.Add(40023, "SceneGroupEnterSceneResp");
            _nameToID.Add("SceneGroupGetStatusReq", 40009);
            _idToName.Add(40009, "SceneGroupGetStatusReq");
            _nameToID.Add("SceneGroupGetStatusResp", 40010);
            _idToName.Add(40010, "SceneGroupGetStatusResp");
            _nameToID.Add("SceneGroupInfo", 10001);
            _idToName.Add(10001, "SceneGroupInfo");
            _nameToID.Add("SceneGroupInfoNotice", 40011);
            _idToName.Add(40011, "SceneGroupInfoNotice");
            _nameToID.Add("SceneGroupInviteReq", 40016);
            _idToName.Add(40016, "SceneGroupInviteReq");
            _nameToID.Add("SceneGroupInviteResp", 40017);
            _idToName.Add(40017, "SceneGroupInviteResp");
            _nameToID.Add("SceneGroupJoinReq", 40014);
            _idToName.Add(40014, "SceneGroupJoinReq");
            _nameToID.Add("SceneGroupJoinResp", 40015);
            _idToName.Add(40015, "SceneGroupJoinResp");
            _nameToID.Add("SceneGroupLeaveReq", 40020);
            _idToName.Add(40020, "SceneGroupLeaveReq");
            _nameToID.Add("SceneGroupLeaveResp", 40021);
            _idToName.Add(40021, "SceneGroupLeaveResp");
            _nameToID.Add("SceneGroupRejectReq", 40018);
            _idToName.Add(40018, "SceneGroupRejectReq");
            _nameToID.Add("SceneGroupRejectResp", 40019);
            _idToName.Add(40019, "SceneGroupRejectResp");
