...
namespace Proto4z
{
    static class Reflection
    {
        ...
        static Reflection()
        {
            ...
            _nameToID.Add("EntityMove", 10034);
            _idToName.Add(10034, "EntityMove");
            ...
            _nameToID.Add("ID_BuffData", 10024);
            _idToName.Add(10024, "ID_BuffData");
            _nameToID.Add("ID_BuffInfo", 10027);
            _idToName.Add(10027, "ID_BuffInfo");
            _nameToID.Add("ID_EPoint", 10020);
            _idToName.Add(10020, "ID_EPoint");
            _nameToID.Add("ID_EntityControl", 10030);
            _idToName.Add(10030, "ID_EntityControl");
            _nameToID.Add("ID_EntityFullData", 10032);
            _idToName.Add(10032, "ID_EntityFullData");
            _nameToID.Add("ID_EntityInfo", 10028);
            _idToName.Add(10028, "ID_EntityInfo");
            _nameToID.Add("ID_EntityPoint", 10029);
            _idToName.Add(10029, "ID_EntityPoint");
            _nameToID.Add("ID_EntityReport", 10031);
            _idToName.Add(10031, "ID_EntityReport");
            _nameToID.Add("ID_HarmData", 10025);
            _idToName.Add(10025, "ID_HarmData");
            _nameToID.Add("ID_SceneGroupAvatarInfo", 10018);
            _idToName.Add(10018, "ID_SceneGroupAvatarInfo");
            _nameToID.Add("ID_SceneGroupInfo", 10019);
            _idToName.Add(10019, "ID_SceneGroupInfo");
            ...
            _nameToID.Add("ID_SceneSection", 10033);
            _idToName.Add(10033, "ID_SceneSection");
            ...
            _nameToID.Add("ID_SearchInfo", 10021);
            _idToName.Add(10021, "ID_SearchInfo");
            _nameToID.Add("ID_SkillBehaviour", 10022);
            _idToName.Add(10022, "ID_SkillBehaviour");
            _nameToID.Add("ID_SkillData", 10023);
            _idToName.Add(10023, "ID_SkillData");
            _nameToID.Add("ID_SkillInfo", 10026);
            _idToName.Add(10026, "ID_SkillInfo");
            ...
            _nameToID.Add("MoveNotice", 50016);
            _idToName.Add(50016, "MoveNotice");
            _nameToID.Add("MoveReq", 50014);
            _idToName.Add(50014, "MoveReq");
            _nameToID.Add("MoveResp", 50015);
            _idToName.Add(50015, "MoveResp");
            ...
            _nameToID.Add("SceneRefreshNotice", 50012);
            _idToName.Add(50012, "SceneRefreshNotice");
            _nameToID.Add("SceneReportsNotice", 50013);
            _idToName.Add(50013, "SceneReportsNotice");
            ...
            _nameToID.Add("UserSkillNotice", 50019);
            _idToName.Add(50019, "UserSkillNotice");
            _nameToID.Add("UserSkillReq", 50017);
            _idToName.Add(50017, "UserSkillReq");
            _nameToID.Add("UserSkillResp", 50018);
            _idToName.Add(50018, "UserSkillResp");
